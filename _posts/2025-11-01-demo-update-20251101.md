...
Using the same principle, I convert all functionalities I need to use right now from Steamworks.net's events to async await functions. I have outputted the wrapper as a [UnityPackage](https://wiseyestudio00.github.io/null-dev-blog/ssets/posts/demo-update-2025-11-01/wiseyestudio_steam.unitypackage) for you to download and play around.
